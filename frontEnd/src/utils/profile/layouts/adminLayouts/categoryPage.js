    ...
    <div class="animate-fadeIn space-y-6">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="size-14 rounded-xl bg-brand-accent/10 flex items-center justify-center">
                                    <i class="fa-solid fa-layer-group text-2xl text-brand-accent"></i>
                                </div>
                            </div>
                        </div>
                    ...
                    <div
                        ...
                        <div class="relative">
                            ...
                            <input type="text" placeholder="جستجوی دسته‌بندی..."
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="size-14 rounded-xl bg-brand-accent/10 flex items-center justify-center">
                                    ...
                                    <i class="fa-solid fa-laptop text-2xl text-brand-accent"></i>
                            ...
                            <div class="flex gap-2 mt-5">
                                ...
                                <button
                                    class="flex-1 h-10 rounded-xl text-brand-primary hover:bg-brand-primary hover:text-white transition-colors duration-300 cursor-pointer">
                                ...
                                <button
                                    class="flex-1 h-10 rounded-xl text-red-500 hover:bg-red-500 hover:text-white transition-colors duration-300 cursor-pointer">
                        ...
                        <div
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="size-14 rounded-xl bg-blue-500/10 flex items-center justify-center">
                                    ...
                                    <i class="fa-solid fa-mobile-screen text-2xl text-blue-500"></i>
