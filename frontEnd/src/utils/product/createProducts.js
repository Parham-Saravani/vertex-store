...
import openProductPageHandler from "./product.js";
import {priceHandler,brandsHandler,categoryHandler,brandsAndCategoriesHandler} from "./filter.js";
...
const createProducts = () => {
  ...
  if(totalProducts.length){
    if(!productsContainer.classList.contains('grid')){
    ...
    productsContainer.insertAdjacentHTML('beforeend',
      ...
      <div class="w-full flex flex-col justify-center items-center mt-10">
          <img src='${emptyState}' class="size-50">
          <p class="w-fulltext-center font-bold dark:text-dark-text-primary text-light-text-primary">محصول مورد نظر یافت نشد</p>
      </div>
      `
    )
  }
